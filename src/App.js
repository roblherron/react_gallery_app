    ...
    return (
      <BrowserRouter>
        <div>
          ...
          <Search onSearch={this.updatePhotosState} queryState={this.state.query} updateQueryState={this.updateQueryState} /> 
      </div>  
        ...
        <div className="main-content">
            <Switch> 
                ...
                <Route path="/search" render={() => <PhotoContainer photos={this.state.photos} queryState={this.state.query} />} />
                {/* this path is never actually rendered 👇 */}
                <Route path="/no-results" render={() => <NotFound queryState={this.state.query}/>} />
            </Switch>  
        </div>
      </BrowserRouter>
    );
